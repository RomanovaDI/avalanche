...
/*asc2dicts [map ascii] [snow depth] [region map ascii] [divided times x] [divided times y ] [divided times z]*/
...
exit_without_massives:
	printf("asc2dicts [map ascii] [snow depth] [region map ascii] [divided times x] [divided times y ] [divided times z]\n");
	return 1;
}
