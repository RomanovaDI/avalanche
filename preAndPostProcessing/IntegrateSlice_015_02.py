...
clip1.ClipType.Origin = [0.15, 0.02500000037252903, 0.15000000596046448]
...
clip2.ClipType.Origin = [0.2, 0.02500000037252903, 0.15000000596046448]
...
# save data
SaveData('./data/015_02/IntegrateSlice.csv', proxy=integrateVariables1, WriteTimeSteps=1,
    Filenamesuffix='_%d',
